...
export default function Dashboard() {
  ...
  return (
    <div className="wrap">
      <Masthead ultimoMesLabel={ultimoMesLabel} />
      ...
      <div className="main-grid">
        <div className="panel">
          <h2>Evolução mensal — Total com encargos</h2>
      ...
      <div className="table-panel">
        <div className="table-head-row">
          <div>
            <h2 style={{ margin: 0 }}>Detalhamento por centro de custo</h2>
...
function Masthead({ ultimoMesLabel }) {
  return (
    <div className="masthead">
      <div className="masthead-left">
        <img className="crest" src="/crest.png" alt="Brasão da Prefeitura de São Miguel dos Campos" />
        <div>
          <h1>Painel da Folha de Pagamento</h1>
          <div className="sub">Prefeitura Municipal de São Miguel dos Campos · Estado de Alagoas</div>
        </div>
      </div>
      <div className={`stamp ${ultimoMesLabel ? '' : 'stamp-empty'}`}>
        ...
        {ultimoMesLabel ? <>DADOS CONFERIDOS <span className="stamp-date">· até {ultimoMesLabel}</span></> : 'AGUARDANDO PRIMEIRO ENVIO'}
      </div>
    </div>
  );
}

    ...
    <div className="wrap" style={{ minHeight: '90vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <form className="upload-card" style={{ maxWidth: 380, width: '100%' }} onSubmit={handleSubmit}>
        <div style={{ textAlign: 'center', marginBottom: 20 }}>
          <img src="/crest.png" alt="Brasão" style={{ width: 64, height: 64, borderRadius: '50%', marginBottom: 10 }} />
          <h2 style={{ margin: '0 0 4px' }}>Painel da Folha de Pagamento</h2>
          <div style={{ fontSize: 12.5, color: 'var(--ink-soft)' }}>Acesso restrito — Prefeitura de São Miguel dos Campos</div>
        </div>
